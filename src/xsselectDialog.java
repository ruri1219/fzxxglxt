 ...
 * @date 2022/12/28
 */
public class xsselectDialog extends JDialog {
    final int WIDTH=400;
     ...
     * @param listener 监听器
     */
    public xsselectDialog(JFrame jf, String title, boolean isModel, ActionDoneListener listener){
        ...
        selectBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(!fzid.equals("") ){
                    ...
                    try {
                        new xsSelectResult(jf, "查询结果", true, id, new ActionDoneListener() {
                            @Override
