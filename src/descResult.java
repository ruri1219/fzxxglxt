 ...
 * @date 2022/12/28
 */
public class descResult extends JDialog {
    final int WIDTH = 850;
     ...
     */
    public descResult(JFrame jf, String title, boolean isModel, ActionDoneListener listener) throws SQLException, ClassNotFoundException {
    ...
    public Vector<Vector> selectgetInformationInterface() throws SQLException, ClassNotFoundException {
        String sql="select * from isyou order by outprice desc";
